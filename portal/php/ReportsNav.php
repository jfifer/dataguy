...
<!-- <button type="button" class="btn btn-info"><a href="all_service_provider.php" style="color:#FFF;">Back</a></button> -->
 <!-- Split button -->
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="js/query_builder/index.html">Report Builder</a></li> 
